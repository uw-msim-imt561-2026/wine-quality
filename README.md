...
Group SOMM selected this dataset out of a shared passion for wine quality, an interest stemmed from study abroad experiences and a deepened appreciation for wine enjoyed across dinners with friends and travels.


To help CVRVV with this R&D and dissemination task, SOMM’s goal is to translate chemical wine data into practical, easy-to-understand dashboard that CVRVV can share with local wineries to improve the quality of their wines. 


Therefore, SOMM’s primary stakeholder is CVRVV as well as the vineyards and wine producers in this region, looking to improve the quality of their wines. A secondary stakeholder would be other wine producers and companies in different regions, who may still find the insights valuable.
