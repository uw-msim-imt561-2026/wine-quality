...
def render_filters(df: pd.DataFrame) -> dict:
    ...
    wine_guide = {
        "Alcohol": "The amount of alcohol in the wine. The more alcohol, the more warmth. Alcohol concentration can be increased or decreased by monitoring the grape sugar concentration prior to the harvest.",
        "Chlorides": "The amount of salt in the wine. High levels can make the wine taste salty.",
        ...
        "Residual Sugar": "Determines sweetness and impacts the overall body (density).",
        "Sulphates": "A wine preservative that contributes to antimicrobial stability and enhances flavor.",
        "Total Sulfur Dioxide": "The total SO2. SO2 is an antioxidant and antimicrobial preservative in wine, preventing spoilage, browning, and unwanted fermentation. If too high, it becomes noticeable to the nose.",
